 ...
 */
export function riskOracleDomain(chainId: number, verifyingContract: Hex): EIP712Domain {
  return {
 ...
 */
export function riskPayloadV2ByKeyMessage(payload: RiskPayloadV2ByKey) {
  return {
 ...
 */
export function riskPayloadV2ByKeyTypedData(
  domain: EIP712Domain,
  payload: RiskPayloadV2ByKey
) {
  return {
    domain: {
      name: domain.name,
    ...
    primaryType: "RiskPayloadV2ByKey" as const,
